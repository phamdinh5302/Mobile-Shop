	...
	<div class="top-nav group">
        <div>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="huongdan.php"><i class="fa fa-file-text-o"></i> Hướng dẫn mua hàng</a></li>
...
function addFooter()
{
    ...
    <div class="footer-widgets footer footer-2 dark">
        <div class="row dark large-columns-4 mb-0">
            <div id="nav_menu-2" class="col pb-0 widget widget_nav_menu"><span class="widget-title">CHĂM SÓC KHÁCH HÀNG</span>
            <div class="is-divider small"></div>
            <div class="menu-menu-cham-soc-khach-hang-container">
                <ul id="menu-menu-cham-soc-khach-hang" class="menu">
                <li id="menu-item-402" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-402"><a href="huongdan.php">Hướng dẫn mua hàng</a></li>
                <li id="menu-item-403" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-403"><a href="#">Mua hàng trả góp</a></li>
                <li id="menu-item-404" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-404"><a href="#">Chính sách bảo hành</a></li>
                <li id="menu-item-405" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-405"><a href="#">Chính sách đổi trả</a></li>
                <li id="menu-item-406" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-406"><a href="#">Chính sách bán hàng</a></li>
                </ul>
            </div>
            </div>
            <div id="nav_menu-3" class="col pb-0 widget widget_nav_menu"><span class="widget-title">VỀ CHÚNG TÔI</span>
            <div class="is-divider small"></div>
            <div class="menu-menu-di-dong-viet-container">
                <ul id="menu-menu-di-dong-viet" class="menu">
                <li id="menu-item-407" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-407"><a href="gioithieu.php">Giới thiệu</a></li>
                <li id="menu-item-408" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-408"><a href="tuyendung.php">Tuyển dụng</a></li>
                <li id="menu-item-409" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-409"><a href="#">Chính sách bảo mật</a></li>
                <li id="menu-item-410" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-410"><a href="#">Chính sách sử dụng</a></li>
            ...
            <div id="text-2" class="col pb-0 widget widget_text"><span class="widget-title">LIÊN KẾT VỚI CHÚNG TÔI</span>
            <div class="is-divider small"></div>
            <div class="textwidget">
                <ul>
                <div id="fb-root"></div>
                    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v18.0" nonce="eco8mUf1"></script>
                <li>
                    <div class="fb-page" data-href="https://www.facebook.com/profile.php?id=61552499917936" data-tabs="timeline" data-width="400" data-height="5" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                        <blockquote cite="https://www.facebook.com/profile.php?id=61552499917936" class="fb-xfbml-parse-ignore">
                            <a href="https://www.facebook.com/profile.php?id=61552499917936">Việt Nam Mobile</a>
                        </blockquote>
                    </div>
                </li>
                </ul>
            ...
            <div id="text-3" class="col pb-0 widget widget_text"><span class="widget-title">CỬA HÀNG VIỆT NAM MOBILE</span>
            <div class="is-divider small"></div>
            <div class="textwidget">
                <ul class="more-info">
                <li><i class="fa fa-map-marker" aria-hidden="true"></i> 96 Định Công, Hoàng Mai, Hà Nội</li>
                <li><i class="fa fa-phone" aria-hidden="true"></i> 0123456789</li>
                <li><i class="fa fa-envelope-o" aria-hidden="true"></i> vietnammobile@gmai.com</li>
                </ul>
            </div>
            </div>
        </div>
    ...
    <div class="copy-right">
        <p>
            ...
            <span style="color: #eee; font-weight: bold">Pham Dinh</span>
        </p>
    </div>';
}
    ...
    <span class="close" onclick="showTaiKhoan(false);">&times;</span> 
        <div class=" taikhoan">
            ...
            <div class="tab-content">
                <div id="login">
                <h3 style ="color:#fff;">Sử dụng tài khoản: dinh231 mật khẩu:123456 để đăng nhập</h3>
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Miễn phí giao hàng tại Hà Nội</li>
                <li>Thanh toán linh hoạt: tiền mặt, visa / master, trả góp</li>
                <li>Trải nghiệm sản phẩm tại nhà</li>
                <li>Lỗi đổi tại nhà trong 1 ngày</li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0123456789" style="color: #288ad6;">01234.56789</a>
                </li>
            </ul>
        </section>
    </div>';
